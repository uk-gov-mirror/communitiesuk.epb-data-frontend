...
csp_options = {
  ...
  form_action: "'self' https://#{ENV['AWS_S3_USER_DATA_BUCKET_NAME']}.s3.eu-west-2.amazonaws.com #{ENV['ONELOGIN_HOST_URL']} https://get-energy-performance-data.epb-staging.digital.communities.gov.uk"
